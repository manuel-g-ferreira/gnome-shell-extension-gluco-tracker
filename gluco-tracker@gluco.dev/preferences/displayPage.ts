...
export var DisplayPage = GObject.registerClass(
    class DisplayPage extends Adw.PreferencesPage {
        ...
        _settingsKey!: SettingsKeyType;

        // Declare new properties to be used later.
        lastIndicatorPos: number = 0;
        posIndicatorOffsetRow!: Adw.SpinRow;
        ...
        _updatePosMax() {
            // Use non-null assertions for _settings and _settingsKey.
            this.lastIndicatorPos = this._settings!.get_int(this._settingsKey!.INDICATOR_POS_MAX);
